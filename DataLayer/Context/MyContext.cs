...
namespace DataLayer.Context
{
    public class MyContext : DbContext
    {
        ...
        public DbSet<RolePool> RolePools { get; set; }
        public DbSet<RoleEqulity> RoleEqulities { get; set; }

        public DbSet<UserPoolReward> UserPoolRewards { get; set; }
        ...
        public DbSet<SupportFund> SupportFunds { get; set; }
        ...
        #endregion
        #region LifeBordro
        public DbSet<LifeBordroBase> LifeBordroBases { get; set; }
        public DbSet<LifeBordroAddition> LifeBordroAdditions { get; set; }
        public DbSet<BordroFileSetting> BordroFileSettings { get; set; }
        public DbSet<CommissionBase> CommissionBases { get; set; }
        public DbSet<Commission> Commissions { get; set; }
        public DbSet<InsuredInformation> InsuredInformation { get; set; }

        #endregion
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<RoleCommission>()
             .HasQueryFilter(r => !r.IsDeleted);
            modelBuilder.Entity<RolePool>()
             .HasQueryFilter(r => !r.IsDeleted);
            modelBuilder.Entity<RoleEqulity>()
             .HasQueryFilter(r => !r.IsDeleted);
            ...
            modelBuilder.Entity<Role>().HasData(
                ...
                new Role { RoleId = 3, RoleTitle = "کاربر ویژه", RoleName = "SpUser" },
                new Role { RoleId = 4, RoleTitle = "پیشکسوت", RoleName = "Veteran" },
                new Role { RoleId = 5, RoleTitle = "مدیر ارشد", RoleName = "Director" },
                new Role { RoleId = 6, RoleTitle = "معاون ارشد", RoleName = "Planner" },
                new Role { RoleId = 7, RoleTitle = "مدیر توسعه", RoleName = "Leader" },
                new Role { RoleId = 8, RoleTitle = "مدیر فروش", RoleName = "Manager" },
                new Role { RoleId = 9, RoleTitle = "سرپرست فروش", RoleName = "Supervisor" },
                new Role { RoleId = 10, RoleTitle = "نماینده", RoleName = "Agent", RoleRate = .75f },
                new Role { RoleId = 11, RoleTitle = "مشاور", RoleName = "Advisor" },
                new Role { RoleId = 12, RoleTitle = "سفیر", RoleName = "Sponsor" },
                new Role { RoleId = 13, RoleTitle = "همیار", RoleName = "Referrer" }
            );
            #endregion           
            #region Users
            modelBuilder.Entity<User>().HasData(
                new User
                {
                    ...
                    IsActive = true,
                    BirthDate = new DateTime(2007, 2, 7),
                    RegDate = DateTime.Now,
                    CountyId = 431,
                    SponserCode = string.Empty
            ...
            modelBuilder.Entity<UserRole>().HasData(
               new UserRole { URId = 1, IsActive = true, RegisterDate = DateTime.Now, User_ID = 1, RoleId = 1 }
            ...
            modelBuilder.Entity<Permission>().HasData(
                ...
                new Permission { PermissionId = 11, PermissionTitle = "آپلود سنتر", ParentId = 1 },
                new Permission { PermissionId = 51, PermissionTitle = "بارگذاری اطلاعات", ParentId = 11 },
                new Permission { PermissionId = 52, PermissionTitle = "گزارش آپلود", ParentId = 11 },

                new Permission { PermissionId = 12, PermissionTitle = "کاربران", ParentId = 1 },
                new Permission { PermissionId = 53, PermissionTitle = "ثبت شده ها", ParentId = 12 },
                new Permission { PermissionId = 54, PermissionTitle = "ویرایش کاربر", ParentId = 12 },
                new Permission { PermissionId = 55, PermissionTitle = "جزئیات کاربر", ParentId = 12 },
                new Permission { PermissionId = 56, PermissionTitle = "تغییر ناظر", ParentId = 12 },
                new Permission { PermissionId = 57, PermissionTitle = "تغییر سمت", ParentId = 12 },
                new Permission { PermissionId = 99, PermissionTitle = "فعال/غیرفعال کردن", ParentId = 12 },

                new Permission { PermissionId = 13, PermissionTitle = "نقشها و مجوزهای دسترسی", ParentId = 1 },
                new Permission { PermissionId = 58, PermissionTitle = "ایجاد نقش", ParentId = 13 },
                new Permission { PermissionId = 59, PermissionTitle = "ویرایش نقش", ParentId = 13 },
                new Permission { PermissionId = 60, PermissionTitle = "حذف نقش", ParentId = 13 },
                new Permission { PermissionId = 61, PermissionTitle = "لیست دسترسی ها", ParentId = 13 },

                new Permission { PermissionId = 14, PermissionTitle = "کاربران سیستم", ParentId = 1 },
                new Permission { PermissionId = 62, PermissionTitle = "لیست کاربران", ParentId = 14 },
                new Permission { PermissionId = 63, PermissionTitle = "افزودن کاربر", ParentId = 14 },

                new Permission { PermissionId = 15, PermissionTitle = "پلن سازمان فروش", ParentId = 1 },
                new Permission { PermissionId = 64, PermissionTitle = "کارمزدهای سطوح", ParentId = 15 },
                new Permission { PermissionId = 65, PermissionTitle = "ایجاد کارمزد", ParentId = 15 },
                new Permission { PermissionId = 66, PermissionTitle = "ویرایش کارمزد", ParentId = 15 },
                new Permission { PermissionId = 67, PermissionTitle = "جزئیات کارمزد", ParentId = 15 },
                new Permission { PermissionId = 68, PermissionTitle = "حذف کارمزد", ParentId = 15 },
                new Permission { PermissionId = 69, PermissionTitle = "پاداشهای همسطحی", ParentId = 15 },
                new Permission { PermissionId = 70, PermissionTitle = "ثبت پاداش", ParentId = 15 },
                new Permission { PermissionId = 71, PermissionTitle = "ویرایش پاداش", ParentId = 15 },
                new Permission { PermissionId = 72, PermissionTitle = "جزئیات پاداش", ParentId = 15 },
                new Permission { PermissionId = 73, PermissionTitle = "حذف پاداش", ParentId = 15 },
                new Permission { PermissionId = 74, PermissionTitle = "پاداشهای استخر", ParentId = 15 },
                new Permission { PermissionId = 75, PermissionTitle = "ایجاد پاداش", ParentId = 15 },
                new Permission { PermissionId = 76, PermissionTitle = "ویرایش پاداش", ParentId = 15 },
                new Permission { PermissionId = 77, PermissionTitle = "جزئیات پاداش", ParentId = 15 },
                new Permission { PermissionId = 78, PermissionTitle = "حذف پاداش", ParentId = 15 },

                new Permission { PermissionId = 16, PermissionTitle = "اخبار", ParentId = 1 },
                new Permission { PermissionId = 79, PermissionTitle = "گروه های خبر", ParentId = 16 },
                new Permission { PermissionId = 80, PermissionTitle = "ایجاد گروه", ParentId = 16 },
                new Permission { PermissionId = 81, PermissionTitle = "ویرایش گروه", ParentId = 16 },
                new Permission { PermissionId = 82, PermissionTitle = "حذف گروه", ParentId = 16 },
                new Permission { PermissionId = 83, PermissionTitle = "ناشران خبر", ParentId = 16 },
                new Permission { PermissionId = 84, PermissionTitle = "ایجاد ناشر", ParentId = 16 },
                new Permission { PermissionId = 85, PermissionTitle = "ویرایش ناشر", ParentId = 16 },
                new Permission { PermissionId = 86, PermissionTitle = "حذف ناشر", ParentId = 16 },
                new Permission { PermissionId = 87, PermissionTitle = "لیست اخبار", ParentId = 16 },
                new Permission { PermissionId = 88, PermissionTitle = "ایجاد خبر", ParentId = 16 },
                new Permission { PermissionId = 89, PermissionTitle = "ویراش خبر", ParentId = 16 },
                new Permission { PermissionId = 90, PermissionTitle = "جزئیات خبر", ParentId = 16 },
                new Permission { PermissionId = 91, PermissionTitle = "حذف خبر", ParentId = 16 },

                new Permission { PermissionId = 17, PermissionTitle = "اسلایدر", ParentId = 1 },
                new Permission { PermissionId = 92, PermissionTitle = "اسلایدها", ParentId = 17 },
                new Permission { PermissionId = 93, PermissionTitle = "ایجاد اسلایدر", ParentId = 17 },
                new Permission { PermissionId = 94, PermissionTitle = "ویرایش اسلایدر", ParentId = 17 },
                new Permission { PermissionId = 95, PermissionTitle = "جزئیات اسلایدر", ParentId = 17 },
                new Permission { PermissionId = 96, PermissionTitle = "حذف اسلایدر", ParentId = 17 },

                new Permission { PermissionId = 18, PermissionTitle = "پیامهای کاربران", ParentId = 1 },
                new Permission { PermissionId = 97, PermissionTitle = "لیست", ParentId = 18 },
                new Permission { PermissionId = 98, PermissionTitle = "ویرایش پیام", ParentId = 18 },


                new Permission { PermissionId = 2, PermissionTitle = "نمودار سازمانی", ParentId = null },

                new Permission { PermissionId = 3, PermissionTitle = "گزارش بوردرو", ParentId = null },
                new Permission { PermissionId = 19, PermissionTitle = "بیمه نامه های شخصی", ParentId = 3 },
                new Permission { PermissionId = 20, PermissionTitle = "بیمه نامه های سازمانی", ParentId = 3 },
                new Permission { PermissionId = 21, PermissionTitle = "تمام بیمه نامه ها (مخصوص ادمین)", ParentId = 3 },
                new Permission { PermissionId = 22, PermissionTitle = "الحاقیه ها", ParentId = 3 },
                new Permission { PermissionId = 23, PermissionTitle = "بیمه شدگان", ParentId = 3 },
                new Permission { PermissionId = 24, PermissionTitle = "عدم وصول", ParentId = 3 },

                new Permission { PermissionId = 4, PermissionTitle = "گزارش کارمزد", ParentId = null },
                new Permission { PermissionId = 25, PermissionTitle = "کارمزد شخصی", ParentId = 4 },
                new Permission { PermissionId = 26, PermissionTitle = "کارمزد سازمانی", ParentId = 4 },
                new Permission { PermissionId = 27, PermissionTitle = "تمام کارمزدها(مخصوص ادمین)", ParentId = 4 },
                new Permission { PermissionId = 28, PermissionTitle = "لیست کارمزد(مخصوص ادمین)", ParentId = 4 },
                new Permission { PermissionId = 29, PermissionTitle = "پاداش بهره وری", ParentId = 4 },

                 new Permission { PermissionId = 30, PermissionTitle = "فایلهای متنی کارمزد (مخصوص ادمین)", ParentId = 1 },
                 new Permission { PermissionId = 31, PermissionTitle = "پیامهای داخلی", ParentId = 1 }
            ...
            {
                modelBuilder.Entity<RolePermission>().HasData(
               new RolePermission { RP_Id = i - 20, RoleId = 1, PermissionId = i });
            }
